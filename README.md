...
[![Java](https://img.shields.io/badge/Java-21-orange)](https://github.com/easy-4-java/jackson-extension) [![License](https://img.shields.io/badge/license-Apache%202.0-green)](./LICENSE)
...
Each line is compiled and tested with its own JDK baseline; dependency versions (including Jackson) may differ per line. Snapshots on this branch are versioned `3.0.x.x.20260630-SNAPSHOT`.
